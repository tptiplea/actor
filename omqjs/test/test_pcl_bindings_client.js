...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _u_=caml_new_string("SENDING_MESSAGE_TO_TEST_SERVER"),
     _r_=
      caml_new_string
     ...
     _o_=caml_new_string("CLIENT: Sent message to TEST server!\n"),
     _i_=caml_new_string("CLIENT: Got the following message from Server:\n"),
     _j_=caml_new_string("\n"),
     _k_=
      caml_new_string
       ("Is remote_socket equal to test_server_addr as expected? -- "),
    ...
    function ok_callback$1(str_local_sckt)
     {print_string(_a_(_t_,_a_(str_local_sckt,_s_)));
      ...
      var
       ...
       msg="Hi there SERVER, I am CLIENT 111!",
     ...
     {print_string(_a_(_C_,_a_(id,_B_)));
      ...
      function f_safe$0(js_str1,js_str2,js_str3)
       {var
        ...
        if(was_request_sent[1])
         {if(caml_string_notequal(local,local))return print_string(_p_);
          if(caml_string_notequal(remote,test_server_addr))
           return print_string(_q_);
          print_string(_i_);
          print_string(msg);
          print_string(_j_);
          print_string(_k_);
