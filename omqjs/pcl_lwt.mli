...
val promise_bind_address : Pcl_bindings.local_sckt_t -> Pcl_bindings.on_msg_callback_t -> unit Lwt.t

val promise_deallocate_address : Pcl_bindings.local_sckt_t -> unit Lwt.t

val promise_connect_to_address : Pcl_bindings.remote_sckt_t -> Pcl_bindings.on_msg_callback_t -> Pcl_bindings.local_sckt_t Lwt.t
